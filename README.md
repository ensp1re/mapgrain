...
npx mapgrain@0.2.2 view diagram.json -o view.html
...
Development CLI: `pnpm mapgrain` (source `0.2.2`). Last published package: `mapgrain@0.2.2`. Historical architecture/workflow package: `mapgrain@0.1.0`. Internals are bundled. Do not use `npx mapgrain@latest`. Do not overwrite `0.1.0` or `0.2.0`.
