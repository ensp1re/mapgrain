...
| Sequence diagrams | shipped | Lifelines, ordered messages, and alt/opt fragments. npm `mapgrain@0.2.0` validates them; `0.1.0` still rejects them |
...
| Agent skill | partial | Install paths proven; live agent prompt runs untested; matching CLI is `npx mapgrain@0.2.0` |
