...
- Status: `active` (harness bootstrap; product queue is `not_started`)
- Current task ID: none
- Active slice: repository harness and quality gates
- Base branch: `main`
...
| --- | --- | --- | --- | --- |
| F001 | Versioned document schema, generated types, runtime validation, original fixtures | — | unit, lint, typecheck, build | not_started |
| F002 | Canonical scene graph: bounds, text, ports, edges, groups | F001 | unit, lint, typecheck, build | not_started |
| F003 | ELK worker layout spike: nesting, cycles, pins, parallel edges | F002 | unit, lint, typecheck, build | not_started |
| F004 | Deterministic SVG/PNG/HTML/JSON export from the scene | F002 | unit, lint, typecheck, build | not_started |
| F005 | Visual specimen in a working app: chrome, node, edge, inspector, one interactive diagram | F003, F004 | unit, lint, typecheck, build | not_started |
| F006 | Editor shell: top bar, canvas, outline, command menu | F005 | unit, lint, typecheck, build | not_started |
| F007 | Direct editing, undo/redo, keep-position | F006 | unit, lint, typecheck, build | not_started |
