...
**Status:** shipped through F055. Live: F056 lifecycle canvas marks and state fills. Closed slices: [docs/archive/](archive/). Product facts: [PROJECT.md](PROJECT.md), [FEATURES.md](FEATURES.md), [CAPABILITY.md](CAPABILITY.md).
