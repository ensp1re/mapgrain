...
**Status:** shipped through F063. Live slice: `F064` (editor crash repair and design system), then `F065` (predictable editing and discoverability) and `F066` (template library and walkthrough). Next task id: `F067`. Closed slices: [docs/archive/](archive/). Product facts: [PROJECT.md](PROJECT.md), [FEATURES.md](FEATURES.md), [CAPABILITY.md](CAPABILITY.md).
