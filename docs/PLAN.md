...
**Status:** F052 active. Bump matching CLI source to 0.2.1 for a patch publish. Closed slices: [docs/archive/](archive/). Product facts: [PROJECT.md](PROJECT.md), [FEATURES.md](FEATURES.md), [CAPABILITY.md](CAPABILITY.md).
