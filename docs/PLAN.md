...
**Status:** shipped through F067. Live slice: `F068` (diagram routing and cards). Next task id: `F069`. Closed slices: [docs/archive/](archive/). Product facts: [PROJECT.md](PROJECT.md), [FEATURES.md](FEATURES.md), [CAPABILITY.md](CAPABILITY.md).
