...
- Task: none
- Plan: docs/PLAN.md
- Git: chore/stamp-f062 @ db6a653217dd33b6f18a775dfc4801dbaaf35050 (dirty)
- Updated: 2026-09-10T12:57:37.935Z

### Next action

Queue F063. Do not start until asked.

### Decisions

- Published npm CLI is npx mapgrain@0.2.2. Source CLI is 0.2.2. Historical npx mapgrain@0.1.0 remains architecture/workflow only. npm 0.2.0 stays published and must not be overwritten.
...
- Sequence alt/opt fragments are in npm mapgrain@0.2.2 and 0.2.0. npm 0.1.0 still rejects them.
...
- https://github.com/ensp1re/mapgrain/pull/89
- https://github.com/ensp1re/mapgrain/actions/runs/34479406571
