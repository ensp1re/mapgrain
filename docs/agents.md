...
Host for this matrix: macOS, Node 24+. CLI prerequisite: Node `>=24 <27` and `npx mapgrain@0.2.1`. Historical `npx mapgrain@0.1.0` still validates architecture/workflow only.
