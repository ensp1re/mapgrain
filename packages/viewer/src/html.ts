...
<body>
  <main class="mapgrain-viewer" data-mode="${VIEW_MODE.READONLY}" aria-label="Read-only diagram">
    <div class="toolbar">
      ...
      <button type="button" data-act="full">${escapeHtml(copy.fullscreen)}</button>
      ...
      <label>${escapeHtml(copy.from)} <select data-act="route-from" aria-label="${escapeHtml(copy.from)}"></select></label>
      <label>${escapeHtml(copy.to)} <select data-act="route-to" aria-label="${escapeHtml(copy.to)}"></select></label>
      <button type="button" data-act="route">${escapeHtml(copy.route)}</button>
      <label>${escapeHtml(copy.view)} <select data-act="view" aria-label="${escapeHtml(copy.view)}"></select></label>
      <label>${escapeHtml(copy.story)} <select data-act="story" aria-label="${escapeHtml(copy.story)}"></select></label>
      ...
      <label>${escapeHtml(copy.lens)} <select data-act="lens" aria-label="${escapeHtml(copy.lens)}"></select></label>
